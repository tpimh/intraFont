...
void draw(void) {
  ...
  x = intraFontPrint(jpn0, 350, y, "�C���g���t�H���g");  //S-JIS encoded text string (flag INTRAFONT_STRING_SJIS set in intraFontLoad call)
  if (x == 350) intraFontPrint(ltn[8], 350, y, "[n/a]");
  ...
  intraFontSetStyle(ltn[8], 1.0f, RED, BLUE, 0.0f, 0);
  x = intraFontPrint(ltn[8], 80, y, "colorful, ");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, 0, 0.0f, 0);
  x = intraFontPrint(ltn[8], x, y, "no shadow, ");
  intraFontSetStyle(ltn[8], 1.0f, 0, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[8], x, y, "no text, ");
  intraFontSetStyle(ltn[8], 1.0f, 0x7FFFFFFF, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[8], x, y, "transparent, ");
  intraFontSetStyle(ltn[8], 1.0f, GRAY, WHITE, 0.0f, 0);
  x = intraFontPrint(ltn[8], x, y, "glowing, ");
  float t = ((float)(clock() % CLOCKS_PER_SEC)) / ((float)CLOCKS_PER_SEC);
  int val = (t < 0.5f) ? t * 511 : (1.0f - t) * 511;
  intraFontSetStyle(ltn[8], 1.0f, LITEGRAY, (0xFF << 24) + (val << 16) + (val << 8) + (val), 0.0f, 0);
  x = intraFontPrint(ltn[8], x, y, "flashing");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, 0);

  y += 17;
  intraFontPrint(ltn[8], 10, y, "Spacing: ");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_WIDTH_FIX);
  x = intraFontPrint(ltn[8], 80, y, "fixed (default), ");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_WIDTH_FIX | 12);
  ...
  intraFontSetStyle(ltn[0], 0.5f, WHITE, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[0], 80, y, "tiny, ");
  intraFontSetStyle(ltn[0], 0.75f, WHITE, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[0], x, y, "small, ");
  intraFontSetStyle(ltn[0], 1.0f, WHITE, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[0], x, y, "regular, ");
  intraFontSetStyle(ltn[0], 1.25f, WHITE, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[0], x, y, "large, ");
  intraFontSetStyle(ltn[0], 1.5f, WHITE, DARKGRAY, 0.0f, 0);
  x = intraFontPrint(ltn[0], x, y, "huge");
  intraFontSetStyle(ltn[0], 1.0f, WHITE, DARKGRAY, 0.0f, 0);

  y += 17;
  intraFontPrint(ltn[8], 10, y, "Align: ");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_ALIGN_LEFT);
  ...
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_ALIGN_CENTER);
  intraFontPrintColumnEx(ltn[8], 225, y, 110, "center aligned w. linebreaks", length);
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_ALIGN_RIGHT);
  intraFontPrintColumnEx(ltn[8], 370, y, 90, "right aligned w. linebreaks ", length);
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_ALIGN_FULL);
  intraFontPrintColumnEx(ltn[8], 380, y, 90, "full justified w. linebreaks", length);
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, 0);

  y += 28;
  intraFontPrint(ltn[8], 10, y, "Scrolling: ");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_SCROLL_LEFT);
  x_scroll1 = intraFontPrintColumn(ltn[8], x_scroll1, y, 80, "This text is scrolled to the left.");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_SCROLL_SEESAW);
  x_scroll2 = intraFontPrintColumn(ltn[8], x_scroll2, y, 90, "Back & forth like a seesaw.");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_SCROLL_RIGHT);
  x_scroll3 = intraFontPrintColumn(ltn[8], x_scroll3, y, 80, "Scrolling to the right...");
  intraFontSetStyle(ltn[8], 1.0f, WHITE, DARKGRAY, 0.0f, INTRAFONT_SCROLL_THROUGH);
